...
export const App: React.FC = () => {
  ...
  return (
    <ErrorBoundary>
      <div className="flex flex-col w-full h-full min-h-screen overflow-hidden bg-[#0a0d14] font-sans">
        {/* Top Application Navigation Bar */}
        <header className="h-14 bg-[#0e131d] border-b border-slate-800/80 px-4 flex items-center justify-between z-30 select-none shadow-xl flex-shrink-0">
          {/* Logo & Product Title */}
        ...
        {/* Bottom Status Bar */}
        <footer className="h-7 bg-[#0b0f17] border-t border-slate-800/80 px-4 flex items-center justify-between text-[11px] text-slate-400 select-none z-20 flex-shrink-0">
