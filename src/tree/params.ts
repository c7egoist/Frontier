...
export interface BotanyParams {
  ...
  leafTuft: number;
  // ----------------------------------------------------------------- cactus / succulent
  /** Number of longitudinal ribs on cactus stems (0 = smooth). 12-24 is typical for saguaro/barrel. */
  ribs: number;
  /** Depth of the ribs as a fraction of radius (0..0.35). */
  ribDepth: number;
  /** Sharpness of the rib grooves: 0 = sinusoidal, 1 = V-shaped areole grooves. */
  ribSharp: number;
  /** Twist of the ribs along the stem, degrees (helical ribs). */
  ribTwist: number;
  /** Height of the tubercle/areole bumps on rib peaks as a fraction of radius. */
  areoleBump: number;
  /** Spacing of areole bumps as a fraction of stem length. */
  areoleSpacing: number;
  /** Flattening of the stem cross-section per level: 0 = circular, 0.9 = highly flat pad (Opuntia). */
  flatness: Level4<number>;
}
...
export const TREE_PRESETS: TreeParams[] = [
  ...
  preset('Desert Ironwood', {
    ...
    leafScale: 0.05,
    leafScaleX: 0.4,
  }, { trunkRadialSegments: 24, minRadialSegments: 12, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.18 }, { count: 5, radius: 0.36, length: 0.2, laterals: 2, forks: 0.5 }),

  // ───────────────────────────────────────── AAA DESERT CACTI & SUCCULENTS ──
  // Each is a closed, welded quad manifold with rib corrugation, areole tubercles
  // and (for Opuntia) flattened pads – not San Andreas octagonal cylinders.
  preset('Saguaro', {
    // Carnegiea gigantea – the 6-12 m Sonoran giant. A stout ribbed column (18 ribs,
    // V-grooves, areole bumps every ~8 cm) with 2–8 upturned arms that emerge from
    // the upper third and bend into the vertical. One surface, genus 0.
    shape: Shape.Cylindrical,
    scale: 7.2,
    scaleV: 1.0,
    levels: 3,
    ...
    flare: 0.18,
    baseSplits: 0,
    baseSize: L(0.48, 0.12, 0.02, 0.02),
    length: L(1, 0.55, 0.36, 0),
    lengthV: L(0, 0.1, 0.08, 0),
    taper: L(0.32, 0.32, 0.28, 1),
    curveRes: L(12, 7, 4, 1),
    curve: L(0, 10, 8, 0),
    curveBack: L(0, 0, 0, 0),
    curveV: L(12, 28, 22, 0),
    ...
    segSplits: L(0, 0, 0, 0),
    splitAngle: L(0, 0, 0, 0),
    downAngle: L(0, 58, 38, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 22, 22, 0),
    branches: L(1, 6, 0, 0),
    branchDist: L(0, 0, 0, 0),
    radiusMod: L(1, 0.62, 0.92, 1),
    attractionUp: 1.35,
    // Spines: needle leaves at rib areoles (areoleSpines() in skeleton.ts)
    leaves: 210,
    leafScale: 0.038,
    leafScaleX: 0.14,
    leafTuft: 1,
    ...
    areoleSpacing: 0.075,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 54, minRadialSegments: 36, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.28, collarLength: 1.05, collarRings: 1, collarFillet: 0.75, collarMitre: 0.5, rootLobeAmplitude: 0.06 }, { count: 4, radius: 0.28, length: 0.13, laterals: 1, forks: 0.2 }),

  preset('Organ Pipe Cactus', {
    // Stenocereus thurberi – 2–8 m multi-columnar, 5–12 erect ribs-stems from the base, tighter ribs than saguaro.
    shape: Shape.Cylindrical,
    scale: 4.2,
    scaleV: 0.9,
    levels: 2,
    ...
    flare: 0.12,
    baseSplits: 5,
    baseSize: L(0.02, 0.05, 0.02, 0.02),
    length: L(1, 0.82, 0.4, 0),
    lengthV: L(0, 0.08, 0.1, 0),
    taper: L(0.4, 0.32, 1, 1),
    curveRes: L(10, 6, 3, 1),
    curve: L(0, 18, 0, 0),
    curveBack: L(0, 0, 0, 0),
    curveV: L(14, 26, 0, 0),
    bendV: L(0, 14, 0, 0),
    segSplits: L(0.12, 0.2, 0, 0),
    splitAngle: L(18, 22, 0, 0),
    splitAngleV: L(6, 8, 0, 0),
    downAngle: L(0, 32, 40, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 24, 24, 0),
    branches: L(1, 4, 0, 0),
    ...
    areoleSpacing: 0.065,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 48, minRadialSegments: 32, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.22, collarLength: 0.95 }, { enabled: false }),

  preset('Golden Barrel', {
    // Echinocactus grusonii – solitary 0.7 m golden barrel, 21–27 ribs with deep V-grooves, helical twist, areole wool.
    shape: Shape.Spherical,
    scale: 0.75,
    scaleV: 0.18,
    levels: 1,
    ...
    flare: 0.06,
    baseSplits: 0,
    baseSize: L(0.02, 0.02, 0.02, 0.02),
    length: L(1, 0.2, 0.2, 0),
    taper: L(0.48, 1, 1, 1),
    curveRes: L(12, 4, 3, 1),
    curve: L(0, 0, 0, 0),
    curveV: L(8, 0, 0, 0),
    ...
    areoleSpacing: 0.045,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 84, minRadialSegments: 42, ringsPerSegment: [5, 2, 2, 1], collarScale: 1.2, rootLobeAmplitude: 0 }, { enabled: false }),

  preset('Prickly Pear', {
    // Opuntia engelmannii – beavertail pads: elliptical cladodes (flatness 0.82–0.86) stacked in 2–3 tiers,
    // oblong pads taper to a notch, glochid areoles faint.
    shape: Shape.Hemispherical,
    scale: 1.35,
    scaleV: 0.35,
    levels: 4,
    ...
    flare: 0.2,
    baseSplits: 2,
    baseSize: L(0.08, 0.08, 0.03, 0.02),
    length: L(1, 0.42, 0.42, 0.34),
    lengthV: L(0, 0.08, 0.08, 0.06),
    taper: L(0.42, 0.58, 0.64, 0.72),
    curveRes: L(8, 6, 6, 4),
    curve: L(0, 14, 12, 8),
    curveBack: L(0, 0, 0, 0),
    curveV: L(22, 44, 40, 30),
    bendV: L(0, 28, 24, 18),
    segSplits: L(0.25, 0.35, 0.25, 0),
    splitAngle: L(42, 44, 42, 0),
    splitAngleV: L(10, 12, 10, 0),
    downAngle: L(0, 52, 56, 50),
    downAngleV: L(0, 14, 14, 14),
    rotate: L(0, 137, 138, 138),
    rotateV: L(0, 28, 28, 20),
    // Five primary pads plus a 6 mm terminal LOD keeps every notch window
    // open; the denser eight-pad variant dropped close overlaps at seed 1/42.
    branches: L(1, 5, 10, 6),
    branchDist: L(0, 0, 0, 0),
    radiusMod: L(1, 0.95, 0.88, 0.82),
    attractionUp: 0.35,
    // Glochids: short bristles scattered over flat pads
    leaves: 90,
    leafScale: 0.018,
    leafScaleX: 0.12,
    leafTuft: 1,
    ...
    areoleBump: 0.012,
    areoleSpacing: 0.09,
    flatness: L(0, 0.82, 0.86, 0.86),
  }, { trunkRadialSegments: 28, minRadialSegments: 14, ringsPerSegment: [4, 3, 3, 2], collarScale: 1.18, collarLength: 1.15, collarMitre: 0.4, cullRadius: 0.006 }, { count: 3, radius: 0.28, length: 0.12 }),

  preset('Teddy Bear Cholla', {
    // Cylindropuntia bigelovii – 1.5–2.5 m tree cholla, segmented cylinders (pendant joints), 12 tubercular ribs,
    // tubercles are areole bumps rather than continuous ribs; dense but rendered as geometry not cards.
    shape: Shape.Spherical,
    scale: 1.9,
    scaleV: 0.5,
    levels: 4,
    ...
    flare: 0.22,
    baseSplits: 1,
    baseSize: L(0.22, 0.06, 0.03, 0.02),
    length: L(1, 0.52, 0.44, 0.32),
    lengthV: L(0, 0.08, 0.08, 0.05),
    taper: L(0.72, 0.64, 0.58, 0.68),
    curveRes: L(8, 7, 6, 4),
    curve: L(6, 16, 14, 8),
    curveV: L(44, 72, 60, 40),
    bendV: L(18, 36, 30, 18),
    segSplits: L(0.3, 0.4, 0.3, 0),
    splitAngle: L(48, 48, 44, 0),
    splitAngleV: L(12, 12, 10, 0),
    downAngle: L(0, 62, 60, 55),
    downAngleV: L(0, 16, 16, 14),
    rotate: L(0, 137, 137, 138),
    rotateV: L(0, 32, 32, 24),
    branches: L(1, 9, 14, 10),
    radiusMod: L(1, 1, 0.96, 0.92),
    attractionUp: 0.55,
    leaves: 220,
    leafScale: 0.028,
    leafScaleX: 0.13,
    ...
    areoleSpacing: 0.055,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 36, minRadialSegments: 24, ringsPerSegment: [3, 3, 2, 2], collarScale: 1.2, collarLength: 1.1 }, { count: 4, radius: 0.32, length: 0.15 }),

  preset('Ocotillo', {
    // Fouquieria splendens – whiplash wands (6 canes, 3–6 m) from the base,
    // faint axial ridges, drought-deciduous micro-leaves after rain.
    shape: Shape.Cylindrical,
    scale: 3.8,
    scaleV: 0.9,
    levels: 2,
    ...
    flare: 0.08,
    baseSplits: 5,
    baseSize: L(0.02, 0.04, 0.02, 0.02),
    length: L(1, 0.92, 0.3, 0),
    lengthV: L(0, 0.08, 0.05, 0),
    taper: L(0.78, 0.70, 1, 1),
    curveRes: L(14, 10, 3, 1),
    curve: L(6, 12, 0, 0),
    curveBack: L(0, 0, 0, 0),
    curveV: L(18, 28, 0, 0),
    bendV: L(8, 14, 0, 0),
    segSplits: L(0, 0, 0, 0),
    splitAngle: L(0, 0, 0, 0),
    downAngle: L(0, 26, 40, 45),
    downAngleV: L(0, 8, 10, 10),
    rotate: L(0, 70, 137, 137),
    rotateV: L(0, 12, 12, 0),
    branches: L(1, 1, 0, 0),
    radiusMod: L(1, 0.92, 1, 1),
    attractionUp: 1.3,
    leaves: 18,
    leafScale: 0.04,
    leafScaleX: 0.45,
    ...
    areoleBump: 0,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 30, minRadialSegments: 12, ringsPerSegment: [3, 2, 2, 1], rootLobeAmplitude: 0.06 }, { enabled: false }),

  preset('Fishhook Barrel', {
    // Ferocactus wislizenii – 0.6–1 m squat barrel, 22 hooked ribs, deeper grooves than Golden Barrel, barrel taper.
    shape: Shape.Hemispherical,
    scale: 0.95,
    scaleV: 0.22,
    levels: 1,
    ...
    ratioPower: 1.0,
    flare: 0.05,
    baseSize: L(0.03, 0.02, 0.02, 0.02),
    length: L(1, 0, 0, 0),
    taper: L(0.52, 1, 1, 1),
    curveRes: L(10, 3, 3, 1),
    curve: L(0, 0, 0, 0),
    ...
    areoleSpacing: 0.05,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 66, minRadialSegments: 44, ringsPerSegment: [5, 2, 2, 1] }, { enabled: false }),

  preset('Beavertail Prickly Pear', {
    // Opuntia basilaris – low, spreading beavertail with flat blue-grey pads in a mat, nearly spineless, very flat.
    shape: Shape.Hemispherical,
    scale: 0.6,
    scaleV: 0.18,
    levels: 3,
    ...
    flare: 0.12,
    baseSplits: 3,
    baseSize: L(0.05, 0.06, 0.03, 0.02),
    length: L(1, 0.38, 0.42, 0),
    lengthV: L(0, 0.06, 0.08, 0),
    taper: L(0.62, 0.68, 0.72, 1),
    curveRes: L(7, 6, 5, 1),
    curve: L(0, 10, 10, 0),
    curveV: L(18, 32, 28, 0),
    bendV: L(0, 20, 18, 0),
    segSplits: L(0.2, 0.25, 0, 0),
    splitAngle: L(38, 42, 0, 0),
    splitAngleV: L(10, 10, 0, 0),
    downAngle: L(0, 58, 52, 45),
    downAngleV: L(0, 12, 12, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 26, 26, 0),
    branches: L(1, 8, 8, 0),
    radiusMod: L(1, 1.05, 0.96, 1),
    attractionUp: 0.25,
    leaves: 80,
    leafScale: 0.016,
    leafScaleX: 0.12,
    ...
    areoleBump: 0.01,
    areoleSpacing: 0.1,
    flatness: L(0, 0.88, 0.88, 0),
  }, { trunkRadialSegments: 26, minRadialSegments: 12, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.16 }, { count: 3, radius: 0.24, length: 0.1 }),

  preset('Cardon', {
    // Pachycereus pringlei – the massive Baja cardón, 10-18 m, heavier than saguaro,
    // 10-12 ribs, many upturned arms from mid-trunk, thicker column.
    shape: Shape.Cylindrical,
    scale: 9.5,
    scaleV: 1.6,
    levels: 3,
    ...
    flare: 0.2,
    baseSplits: 0,
    baseSize: L(0.42, 0.1, 0.02, 0.02),
    length: L(1, 0.58, 0.38, 0),
    lengthV: L(0, 0.09, 0.07, 0),
    taper: L(0.34, 0.34, 0.30, 1),
    curveRes: L(12, 7, 4, 1),
    curve: L(0, 9, 7, 0),
    curveV: L(12, 24, 20, 0),
    bendV: L(0, 16, 10, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 54, 36, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 20, 20, 0),
    branches: L(1, 9, 0, 0),
    radiusMod: L(1, 0.66, 0.9, 1),
    attractionUp: 1.3,
    leaves: 190,
    leafScale: 0.036,
    leafScaleX: 0.13,
    ...
    areoleSpacing: 0.08,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 44, minRadialSegments: 22, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.26, collarLength: 1.05, collarFillet: 0.7 }, { count: 4, radius: 0.26, length: 0.12 }),

  preset('Pincushion Cactus', {
    // Mammillaria bocasana – small 8-12 cm globular pincushion, tubercles (not ribs),
    // dense radial spines and hooked centrals. Single barrel plus offsets.
    shape: Shape.Spherical,
    scale: 0.16,
    scaleV: 0.05,
    levels: 2,
    ...
    flare: 0.05,
    baseSplits: 0,
    baseSize: L(0.04, 0.04, 0.02, 0.02),
    length: L(1, 0.42, 0.3, 0),
    lengthV: L(0, 0.08, 0.06, 0),
    taper: L(0.62, 0.55, 1, 1),
    curveRes: L(10, 6, 4, 1),
    curve: L(0, 6, 0, 0),
    curveV: L(12, 18, 0, 0),
    bendV: L(0, 12, 0, 0),
    segSplits: L(0, 0, 0, 0),
    splitAngle: L(32, 32, 0, 0),
    splitAngleV: L(10, 10, 0, 0),
    downAngle: L(0, 38, 40, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 24, 24, 0),
    branches: L(1, 6, 0, 0),
    radiusMod: L(1, 0.42, 1, 1),
    attractionUp: 0.2,
    leaves: 150,
    leafScale: 0.014,
    leafScaleX: 0.11,
    ...
    areoleSpacing: 0.052,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 32, minRadialSegments: 16, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.2 }, { enabled: false }),

  preset('Claret Cup', {
    // Echinocereus triglochidiatus – clustering 8-12 small cylinders 10-30 cm,
    // 7-11 ribs, brilliant red cups. Low mat of ribbed fingers.
    shape: Shape.Hemispherical,
    scale: 0.28,
    scaleV: 0.08,
    levels: 2,
    ...
    flare: 0.06,
    baseSplits: 6,
    baseSize: L(0.03, 0.04, 0.02, 0.02),
    length: L(1, 0.72, 0.3, 0),
    lengthV: L(0, 0.08, 0.06, 0),
    taper: L(0.48, 0.44, 1, 1),
    curveRes: L(10, 7, 3, 1),
    curve: L(0, 8, 0, 0),
    curveV: L(18, 22, 0, 0),
    bendV: L(0, 14, 0, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 28, 40, 45),
    downAngleV: L(0, 8, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 20, 20, 0),
    branches: L(1, 2, 0, 0),
    ...
    areoleSpacing: 0.06,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 36, minRadialSegments: 18, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.22 }, { enabled: false }),


  // ──────────────────────────────────────── verified desert additions ────────
  // Distinct silhouettes, not duplicate barrel variants: a fence of columns,
  // a woolly senita, a low rainbow cluster, and a dense lady-finger mat.
  // Each uses the rib/areole surface and the same welded branch windows.
  preset('Mexican Fencepost', {
    // Pachycereus marginatus – straight, blue-green columns in a close basal
    // cluster. Sparse areoles and seven broad ribs keep the silhouette clean.
    shape: Shape.Cylindrical,
    scale: 4.2,
    scaleV: 0.7,
    levels: 2,
    ...
    flare: 0.1,
    baseSplits: 4,
    baseSize: L(0.04, 0.06, 0.02, 0.02),
    length: L(1, 0.84, 0.3, 0),
    lengthV: L(0, 0.06, 0.05, 0),
    taper: L(0.34, 0.32, 1, 1),
    curveRes: L(13, 6, 3, 1),
    curve: L(0, 5, 0, 0),
    curveV: L(8, 18, 0, 0),
    bendV: L(0, 9, 0, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 28, 40, 45),
    downAngleV: L(0, 7, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 12, 12, 0),
    branches: L(1, 0, 0, 0),
    radiusMod: L(1, 0.84, 1, 1),
    attractionUp: 1.4,
    leaves: 92,
    leafScale: 0.026,
    leafScaleX: 0.12,
    ...
    areoleSpacing: 0.09,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 42, minRadialSegments: 24, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.22, collarLength: 1.0 }, { enabled: false }),

  preset('Senita Cactus', {
    // Lophocereus schottii – narrow, many-ribbed columns with a few high arms;
    // the pale spine tufts are deliberately short so the wool does not become
    // a noisy green leaf crown.
    shape: Shape.Cylindrical,
    scale: 5.4,
    scaleV: 0.9,
    levels: 3,
    ...
    flare: 0.12,
    baseSplits: 1,
    baseSize: L(0.34, 0.08, 0.02, 0.02),
    length: L(1, 0.6, 0.38, 0),
    lengthV: L(0, 0.08, 0.06, 0),
    taper: L(0.36, 0.34, 0.3, 1),
    curveRes: L(12, 7, 4, 1),
    curve: L(0, 8, 6, 0),
    curveV: L(10, 24, 18, 0),
    bendV: L(0, 16, 12, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 52, 36, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 20, 20, 0),
    branches: L(1, 5, 0, 0),
    radiusMod: L(1, 0.7, 0.9, 1),
    attractionUp: 1.25,
    leaves: 145,
    leafScale: 0.022,
    leafScaleX: 0.16,
    ...
    areoleSpacing: 0.07,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 44, minRadialSegments: 24, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.24, collarLength: 1.02 }, { enabled: false }),

  preset('Texas Rainbow Cactus', {
    // Echinocereus dasyacanthus – low clustered cylinders, nine to eleven ribs,
    // and a dense radial spine coat. The cluster is broad, never a single tube.
    shape: Shape.Hemispherical,
    scale: 0.42,
    scaleV: 0.1,
    levels: 2,
    ...
    flare: 0.05,
    baseSplits: 7,
    baseSize: L(0.025, 0.04, 0.02, 0.02),
    length: L(1, 0.68, 0.28, 0),
    lengthV: L(0, 0.1, 0.08, 0),
    taper: L(0.5, 0.46, 1, 1),
    curveRes: L(10, 7, 3, 1),
    curve: L(0, 7, 0, 0),
    curveV: L(15, 24, 0, 0),
    bendV: L(0, 16, 0, 0),
    segSplits: L(0, 0.08, 0, 0),
    splitAngle: L(30, 34, 0, 0),
    splitAngleV: L(8, 10, 0, 0),
    downAngle: L(0, 30, 40, 45),
    downAngleV: L(0, 8, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 18, 18, 0),
    branches: L(1, 2, 0, 0),
    ...
    areoleSpacing: 0.055,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 38, minRadialSegments: 18, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.2 }, { enabled: false }),

  preset('Lady Finger Cactus', {
    // Mammillaria elongata – dozens of slender, golden fingers packed into a
    // low mound. Short rib spacing and small areole bumps preserve the tubercle
    // rhythm instead of turning the cluster into green sausages.
    shape: Shape.Hemispherical,
    scale: 0.34,
    scaleV: 0.08,
    levels: 2,
    ...
    flare: 0.04,
    baseSplits: 7,
    baseSize: L(0.025, 0.035, 0.02, 0.02),
    length: L(1, 0.62, 0.24, 0),
    lengthV: L(0, 0.1, 0.07, 0),
    taper: L(0.42, 0.4, 1, 1),
    curveRes: L(9, 6, 3, 1),
    curve: L(0, 10, 0, 0),
    curveV: L(18, 26, 0, 0),
    bendV: L(0, 18, 0, 0),
    segSplits: L(0, 0.16, 0, 0),
    splitAngle: L(24, 28, 0, 0),
    splitAngleV: L(8, 10, 0, 0),
    downAngle: L(0, 34, 42, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 22, 22, 0),
    branches: L(1, 3, 0, 0),
    radiusMod: L(1, 0.8, 1, 1),
    attractionUp: 0.6,
    leaves: 165,
    leafScale: 0.021,
    leafScaleX: 0.13,
    ...
    areoleSpacing: 0.042,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 40, minRadialSegments: 18, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.18 }, { enabled: false }),


  // ──────────────────────────────────────── desert additions · columnar set ─
  preset('Blue Myrtle Cactus', {
    // Myrtillocactus geometrizans – blue-grey candelabra cactus with a stout
    // central column and a few high, upward arms. Seven ribs keep the profile
    // broad and architectural without turning it into a faceted tube.
    shape: Shape.Cylindrical,
    scale: 4.8,
    scaleV: 0.8,
    levels: 3,
    ...
    flare: 0.15,
    baseSplits: 0,
    baseSize: L(0.38, 0.1, 0.02, 0.02),
    length: L(1, 0.58, 0.38, 0),
    lengthV: L(0, 0.08, 0.06, 0),
    taper: L(0.35, 0.33, 0.29, 1),
    curveRes: L(12, 7, 4, 1),
    curve: L(0, 8, 7, 0),
    curveV: L(10, 22, 18, 0),
    bendV: L(0, 16, 12, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 54, 38, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 20, 20, 0),
    branches: L(1, 6, 2, 0),
    radiusMod: L(1, 0.7, 0.88, 1),
    attractionUp: 1.25,
    leaves: 125,
    leafScale: 0.025,
    leafScaleX: 0.15,
    ...
    areoleSpacing: 0.075,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 46, minRadialSegments: 26, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.24, collarLength: 1.02 }, { count: 4, radius: 0.26, length: 0.13, laterals: 1, forks: 0.2 }),

  preset('Peruvian Apple Cactus', {
    // Cereus repandus – tall blue-green column with sparse, high candelabra
    // branches. The moderate rib depth is intentional: this species reads as
    // smooth and waxy at game distance, not as a golden barrel.
    shape: Shape.Cylindrical,
    scale: 6.4,
    scaleV: 1.0,
    levels: 3,
    ...
    baseSplits: 0,
    baseSize: L(0.42, 0.1, 0.02, 0.02),
    length: L(1, 0.55, 0.34, 0),
    lengthV: L(0, 0.08, 0.07, 0),
    taper: L(0.32, 0.31, 0.28, 1),
    curveRes: L(13, 7, 4, 1),
    curve: L(0, 7, 6, 0),
    curveV: L(10, 20, 18, 0),
    bendV: L(0, 14, 10, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 50, 36, 45),
    downAngleV: L(0, 10, 10, 10),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 22, 22, 0),
    branches: L(1, 5, 2, 0),
    radiusMod: L(1, 0.68, 0.9, 1),
    attractionUp: 1.35,
    leaves: 135,
    leafScale: 0.024,
    leafScaleX: 0.15,
    ...
    areoleSpacing: 0.08,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 44, minRadialSegments: 24, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.23, collarLength: 1.02 }, { count: 4, radius: 0.28, length: 0.14, laterals: 1, forks: 0.2 }),

  preset('Totem Pole Cactus', {
    // Pachycereus schottii monstrosus – spineless, blue-green column with
    // irregular knobby growth. Surface bumps replace the spine coat; keeping
    // leaves at zero prevents a false foliage crown.
    shape: Shape.Cylindrical,
    scale: 3.4,
    scaleV: 0.65,
    levels: 2,
    ...
    flare: 0.12,
    baseSplits: 2,
    baseSize: L(0.26, 0.08, 0.02, 0.02),
    length: L(1, 0.78, 0.3, 0),
    lengthV: L(0, 0.08, 0.06, 0),
    taper: L(0.38, 0.34, 1, 1),
    curveRes: L(11, 6, 3, 1),
    curve: L(0, 12, 0, 0),
    curveV: L(16, 26, 0, 0),
    bendV: L(0, 18, 0, 0),
    segSplits: L(0.08, 0.12, 0, 0),
    splitAngle: L(16, 22, 0, 0),
    splitAngleV: L(6, 8, 0, 0),
    downAngle: L(0, 30, 40, 45),
    downAngleV: L(0, 8, 10, 10),
    rotate: L(0, 137, 137, 137),
    ...
    areoleSpacing: 0.11,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 40, minRadialSegments: 22, ringsPerSegment: [4, 3, 2, 1], collarScale: 1.2, collarLength: 1.0 }, { enabled: false }),

  preset('Ponytail Palm', {
    // Beaucarnea recurvata – swollen caudex, narrow upper trunk and a dense
    // fountain of strap leaves. It is a desert succulent tree, not a palm;
    // the tufted proxy cards stay at the ends of the few upper branches.
    shape: Shape.Hemispherical,
    scale: 2.8,
    scaleV: 0.45,
    levels: 3,
    ...
    flare: 1.05,
    baseSplits: 0,
    baseSize: L(0.2, 0.14, 0.02, 0.02),
    length: L(1, 0.52, 0.28, 0),
    lengthV: L(0, 0.06, 0.08, 0),
    taper: L(0.78, 0.76, 0.72, 1),
    curveRes: L(10, 6, 4, 1),
    curve: L(0, 10, 8, 0),
    curveV: L(12, 28, 24, 0),
    bendV: L(0, 20, 16, 0),
    segSplits: L(0, 0, 0, 0),
    downAngle: L(0, 56, 62, 52),
    downAngleV: L(0, 10, 16, 16),
    rotate: L(0, 137, 137, 137),
    rotateV: L(0, 25, 25, 0),
    branches: L(1, 4, 0, 0),
    radiusMod: L(1, 0.65, 0.7, 1),
    attractionUp: 0.55,
    nodeSwell: 0.17,
    nodeSpacing: 0.2,
    leaves: 180,
    ...
    areoleBump: 0,
    flatness: L(0, 0, 0, 0),
  }, { trunkRadialSegments: 28, minRadialSegments: 14, ringsPerSegment: [4, 3, 2, 1], rootLobeAmplitude: 0.4, rootLobeHeight: 0.12 }, { count: 5, radius: 0.42, length: 0.22, laterals: 1, forks: 0.4 }),
