...
export const TREE_PRESETS: TreeParams[] = [
  ...
  }, { trunkRadialSegments: 28, minRadialSegments: 14, ringsPerSegment: [4, 3, 3, 2], collarScale: 1.18, collarLength: 1.15, collarMitre: 0.4 }, { count: 3, radius: 0.28, length: 0.12 }),
