...
export const GRASS_GROUPS: { label: string; names: string[] }[] = [
  ...
  { label: 'Desert · succulents', names: ['Century Agave', "Parry's Agave", 'Aloe Vera', 'Desert Spoon', 'Echeveria', 'Haworthia', 'Jade Plant', 'Blue Agave', 'Red Yucca', 'Beargrass', 'Dudleya Rosette', 'Living Stones', 'Snake Plant'] },
];
