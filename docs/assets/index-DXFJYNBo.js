...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new H(0,1,0);return new na({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=mc(i,i.VERTEX_SHADER,y),S=mc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=bc(i,x,`vertex`),n=bc(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  void main(){
    ...
    <div class="panel-footer"><span id="olFoot">—</span><div class="spacer"></div><span id="olHits"></span></div>`;let i=e.querySelector(`#olTree`),a=e.querySelector(`#olSub`),o=e.querySelector(`#olChips`),s=e.querySelector(`#olSearch`),c=e.querySelector(`#olClear`),l=hd([`All types`,...Object.keys(Ul).filter(e=>e!==`folder`).map(e=>Ul[e].label)],`All types`,e=>{e===`All types`?r.clear():r.has(e)?r.delete(e):r.add(e),l._set(r.size===0?`All types`:r.size===1?[...r][0]:`${r.size} types`),x()},{width:118});e.querySelector(`#olFilter`).appendChild(l),s.addEventListener(`input`,()=>{n=s.value.trim().toLowerCase(),x()}),s.addEventListener(`keydown`,e=>{e.stopPropagation(),e.key===`Escape`&&(s.value=``,n=``,x())}),c.onclick=()=>{s.value=``,n=``,x(),s.focus()},e.querySelector(`#olExpand`).onclick=()=>{Jl.forEach(e=>e.open=!0),x()},e.querySelector(`#olCollapse`).onclick=()=>{Jl.forEach(e=>{e.depth===0&&(e.open=!1)}),x()};let u=e=>{let t=!n||e.name.toLowerCase().includes(n)||Ql(e).label.toLowerCase().includes(n),i=!r.size||r.has(Ql(e).label);return t&&i},d=e=>u(e)||e.kids.some(d),f=e=>{if(!n)return p(e);let t=e.toLowerCase().indexOf(n);return t<0?p(e):p(e.slice(0,t))+`<mark>`+p(e.slice(t,t+n.length))+`</mark>`+p(e.slice(t+n.length))},p=e=>e.replace(/[&<>"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`})[e]);function m(e,t){let n=t.nextElementSibling;if(!n||!n.classList.contains(`kids`))return;let r=t.querySelector(`.tw`);e.open=!e.open,r.classList.toggle(`open`,e.open);let i=n.scrollHeight;e.open?(n.classList.remove(`shut`),n.style.height=i+`px`,setTimeout(()=>{e.open&&(n.style.height=`auto`)},270)):(n.style.height=i+`px`,requestAnimationFrame(()=>{n.style.height=`0px`,n.classList.add(`shut`)}))}let h=null,g=Y(`div`);g.style.cssText=`position:fixed;height:2px;background:var(--hi);border-radius:2px;z-index:400;display:none;box-shadow:0 0 8px rgba(108,119,255,.9);pointer-events:none;`,document.body.appendChild(g);let _=Y(`div`);_.style.cssText=`position:fixed;z-index:401;pointer-events:none;display:none;background:rgba(20,20,20,.92);border:1px solid var(--stroke-strong);border-radius:999px;padding:5px 12px;font-size:11.5px;box-shadow:var(--shadow-pop);`,document.body.appendChild(_);let v=(e,t)=>{let n=t;for(;n;){if(n===e)return!0;n=n.parent}return!1},y=e=>{let t=e.parent?e.parent.kids:ql;t.splice(t.indexOf(e),1)};function b(e,n){h={node:e,target:null,mode:null},_.textContent=e.name,_.style.display=`block`;let r=t=>{_.style.left=t.clientX+12+`px`,_.style.top=t.clientY+10+`px`;let n=document.elementFromPoint(t.clientX,t.clientY)?.closest(`.row`);if(g.style.display=`none`,i.querySelectorAll(`.row`).forEach(e=>e.style.background=``),h.target=null,!n||!n.dataset.id)return;let r=Jl.find(e=>e.id===+n.dataset.id);if(!r||v(e,r))return;let a=n.getBoundingClientRect(),o=(t.clientY-a.top)/a.height,s=Zl(r)?o<.25?`before`:o>.75?`after`:`inside`:o<.5?`before`:`after`;h.target=r,h.mode=s,s===`inside`?n.style.background=`rgba(108,119,255,.18)`:(g.style.display=`block`,g.style.left=a.left+`px`,g.style.width=a.width+`px`,g.style.top=(s===`before`?a.top:a.bottom)-1+`px`)},a=()=>{if(removeEventListener(`pointermove`,r),removeEventListener(`pointerup`,a),_.style.display=`none`,g.style.display=`none`,i.querySelectorAll(`.row`).forEach(e=>e.style.background=``),h?.target){let{node:e,target:n,mode:r}=h;if(y(e),r===`inside`)n.kids.push(e),n.open=!0;else{let t=n.parent?n.parent.kids:ql,i=t.indexOf(n);t.splice(r===`before`?i:i+1,0,e)}Yl(),t.toast(`Moved <b>${e.name}</b>`),bd.emit(`treechange`)}h=null};addEventListener(`pointermove`,r),addEventListener(`pointerup`,a),r(n)}function x(){Yl(),i.innerHTML=``;let s=0,h=(e,i)=>e.forEach(e=>{if(!d(e))return;s++;let a=Ql(e),o=Y(`div`,`row`);o.dataset.id=e.id,t.selection.has(e.id)&&o.classList.add(`sel`),t.cursorId===e.id&&o.classList.add(`cursor`),(!e.vis||!ou(e))&&o.classList.add(`hidden-node`),e.locked&&o.classList.add(`locked`),o.style.paddingLeft=7+e.depth*15+`px`;let c=!e.kids.length,l=n||r.size?!0:e.open,u=Zl(e)&&e.props.tint||a.color;if(o.innerHTML=`<span class="tw ${c?`leaf`:``} ${l?`open`:``}">${J(`chev`,{size:12})}</span>
         ...
         <button class="st ${e.vis?``:`off`}" data-a="vis" title="Visibility">${J(e.vis?`eye`:`eyeoff`,{size:12})}</button>`,c||(o.querySelector(`.tw`).onclick=t=>{t.stopPropagation(),m(e,o)}),o.querySelectorAll(`.st`).forEach(n=>n.onclick=r=>{r.stopPropagation();let i=n.dataset.a;if(i===`vis`&&(e.vis=!e.vis),i===`lock`&&(e.locked=!e.locked),i===`solo`){t.toggleIsolateNode(e);return}bd.emit(`treechange`)}),o.onclick=n=>t.select(e.id,{additive:n.ctrlKey||n.metaKey,range:n.shiftKey}),o.ondblclick=n=>{if(n.stopPropagation(),Zl(e)){m(e,o);return}t.focus(e)},o.oncontextmenu=n=>{n.preventDefault(),t.contextMenu(e,n)},o.addEventListener(`pointerdown`,t=>{if(t.button!==0||t.target.closest(`.st`)||t.target.closest(`.tw`))return;let n=t.clientX,r=t.clientY,i=t=>{Math.hypot(t.clientX-n,t.clientY-r)>6&&(removeEventListener(`pointermove`,i),removeEventListener(`pointerup`,a),b(e,t))},a=()=>{removeEventListener(`pointermove`,i),removeEventListener(`pointerup`,a)};addEventListener(`pointermove`,i),addEventListener(`pointerup`,a)}),o.querySelector(`.nm`).addEventListener(`dblclick`,t=>{t.stopPropagation(),gd(e,o.querySelector(`.nm`),()=>{bd.emit(`treechange`)})}),i.appendChild(o),!c){let t=Y(`div`,`kids`+(l?``:` shut`));l||(t.style.height=`0px`),i.appendChild(t),h(e.kids,t)}});h(ql,i),s||(i.innerHTML=`<div class="nohits">Nothing matches “${p(n)}”</div>`),i.querySelectorAll(`.kids:not(.shut)`).forEach(e=>e.style.height=`auto`);let g=Jl.filter(e=>!Zl(e)).length,_=Jl.filter(e=>!Zl(e)&&u(e)).length;a.textContent=`${g} entities · ${ql.length} groups`,e.querySelector(`#olHits`).textContent=n||r.size?`${_} of ${g}`:``,e.querySelector(`#olFoot`).textContent=t.selection.size===0?`Nothing selected`:t.selection.size===1?`${Jl.find(e=>e.id===[...t.selection][0])?.name??``} selected`:`${t.selection.size} selected`,c.style.display=n?`grid`:`none`,o.innerHTML=[...r].map(e=>`<span class="pill">${e}<button class="px" data-t="${e}">✕</button></span>`).join(``),o.querySelectorAll(`.px`).forEach(e=>e.onclick=()=>{r.delete(e.dataset.t),l._set(r.size===0?`All types`:r.size===1?[...r][0]:`${r.size} types`),x()})}function S(e){let t=e.parent;for(;t;)t.open=!0,t=t.parent;x(),i.querySelector(`.row[data-id="${e.id}"]`)?.scrollIntoView({block:`nearest`,behavior:`smooth`})}return{render:x,revealNode:S,get query(){return n}}}var Sd=[`#c9a24b`,`#ef5350`,`#f59e0b`,`#22c55e`,`#3b82f6`,`#8b5cf6`,`#ec4899`,`#9aa0a6`],Cd=new Set;bd.on(`propchange`,({node:e,src:t})=>Cd.forEach(n=>{n!==t&&n.node===e&&n.sync()}));function wd(e,t,n,r){e.props[t]=n,bd.emit(`propchange`,{node:e,key:t,value:n,src:r})}function Td(e,t,{wide:n=!1}={}){let r=Y(`div`,`prow${n?` wide`:``}`);return r.append(Y(`span`,`pl`,e),t),r}function Ed(e,t,n){let r=e.props[t.k];switch(t.kind){case`slider`:return ud({min:t.min,max:t.max,value:r??t.def,dec:t.dec,unit:t.unit,hi:t.hi,thin:n.compact,onInput:r=>wd(e,t.k,r,n)});case`switch`:return dd(r,r=>wd(e,t.k,r,n));case`vec3`:return fd(r||[0,0,0],{step:t.step,disabled:e.locked,dec:2,onChange:r=>wd(e,t.k,r,n)});case`color`:return t.swatches?md(r,Sd,r=>wd(e,t.k,r,n)):pd(r,r=>wd(e,t.k,r,n));case`select`:return hd(t.options,r,r=>wd(e,t.k,r,n));case`readout`:{let n=Y(`span`,`val`,Dd(e,t.k));return n._set=()=>{n.textContent=Dd(e,t.k)},n}default:return Y(`span`,`val`,String(r))}}var Dd=(e,t)=>t===`children`?`${e.kids.length} direct · ${(function e(t){return t.reduce((t,n)=>t+1+e(n.kids),0)})(e.kids)} total`:String(e.props[t]??`—`);function Od(e,{compact:t=!1,onDirty:n=()=>{}}={}){let r=Y(`div`,`sheet`),i=[],a={node:e,compact:t,sync:()=>i.forEach(t=>t.ctl._set&&t.ctl._set(e.props[t.def.k]))};Cd.add(a),r._dispose=()=>Cd.delete(a);let o=Ql(e);t||s();function s(){let t=Y(`div`,`ident`);t.innerHTML=`<div class="glyph">${J(o.icon,{size:18,color:e.props.tint||o.color})}</div>
     <div class="who"><span class="name-edit" title="Double click to rename">${e.name}</span>
       <div class="kind">${o.label}${e.locked?` · locked`:``}${e.vis?``:` · hidden`}</div></div>`;let i=Y(`div`,`row-actions`);i.style.cssText=`display:flex;gap:6px;`;let a=Y(`button`,`iconbtn ghost${e.vis?``:` on`}`,J(e.vis?`eye`:`eyeoff`,{size:13}));a.title=`Visibility  (H)`,a.onclick=()=>{e.vis=!e.vis,bd.emit(`treechange`),n()};let s=Y(`button`,`iconbtn ghost${e.locked?` on`:``}`,J(e.locked?`lock`:`unlock`,{size:13}));s.title=`Lock  (L)`,s.onclick=()=>{e.locked=!e.locked,bd.emit(`treechange`),n()},i.append(a,s),t.appendChild(i),t.querySelector(`.name-edit`).ondblclick=t=>{gd(e,t.currentTarget,()=>{bd.emit(`treechange`),n()})},r.appendChild(t)}if((o.groups||[]).forEach((n,o)=>{let s=Y(`div`,`pcard`),c=Y(`h4`,null,`${n.title}<span class="cw">${J(`chevdown`,{size:12})}</span>`),l=Y(`div`,`pbody`);c.onclick=()=>{s.classList.toggle(`shut`),s.classList.contains(`shut`)||_d(s)},s.append(c,l),n.props.forEach(t=>{let n=Ed(e,t,a);i.push({def:t,ctl:n}),l.appendChild(Td(t.label,n))}),r.appendChild(s),t&&o>2&&s.classList.add(`shut`)}),!Zl(e)){let t=Y(`div`,`pcard`);t.innerHTML=`<h4>Object<span class="cw">${J(`chevdown`,{size:12})}</span></h4>`;let i=Y(`div`,`pbody`);t.appendChild(i),t.querySelector(`h4`).onclick=()=>t.classList.toggle(`shut`),i.append(Td(`Visible`,dd(e.vis,t=>{e.vis=t,bd.emit(`treechange`),n()})),Td(`Locked`,dd(e.locked,t=>{e.locked=t,bd.emit(`treechange`),n()})),Td(`Dynamic`,dd(e.dynamic,t=>{e.dynamic=t,bd.emit(`treechange`)})),Td(`Type`,Y(`span`,`val`,Ul[e.type].label)),Td(`ID`,Y(`span`,`val`,`#${String(e.id).padStart(3,`0`)}`))),r.appendChild(t)}let c=Y(`div`,`pcard`);c.innerHTML=`<h4>Notes<span class="cw">${J(`chevdown`,{size:12})}</span></h4>`;let l=Y(`div`,`pbody`),u=Y(`textarea`,`notes`);return u.placeholder=`Notes for ${e.name}…`,u.spellcheck=!1,u.value=e.notes||``,u.oninput=()=>{e.notes=u.value},u.onkeydown=e=>e.stopPropagation(),l.appendChild(u),c.appendChild(l),c.querySelector(`h4`).onclick=e=>{e.target.closest(`textarea`)||c.classList.toggle(`shut`)},t&&c.classList.add(`shut`),r.appendChild(c),r}function kd(e,t,n=()=>({left:8,top:8,right:innerWidth-8,bottom:innerHeight-8})){let r=new Map;function i(e){let t=r.get(e);t&&(t.elm.classList.add(`closing`),t.sheet._dispose&&t.sheet._dispose(),t.tether.remove(),setTimeout(()=>t.elm.remove(),160),r.delete(e))}let a=()=>[...r.keys()].forEach(i);function o(e){return r.has(e.id)?(i(e.id),null):s(e)}function s(n){if(r.has(n.id))return c(r.get(n.id)),r.get(n.id);let a=Ql(n),o=Y(`div`,`pop`),s=Y(`div`);s.style.cssText=`position:absolute;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.45),rgba(255,255,255,.12));transform-origin:0 50%;pointer-events:none;z-index:-1;`,e.appendChild(s);let u=Y(`div`,`pop-head`,`<div class="glyph">${J(a.icon,{size:14,color:a.color})}</div>
       <div style="min-width:0;flex:1">
         <div class="t"></div><div class="s">${a.label}</div>
       </div>`),d=u.querySelector(`.t`);d.textContent=n.name,d.title=`Double click to rename`,d.style.cursor=`text`,d.ondblclick=()=>gd(n,d,()=>{d.textContent=n.name,t.refreshChrome()});let f=Y(`button`,`iconbtn ghost`,J(n.vis?`eye`:`eyeoff`,{size:12}));f.title=`Visibility  (H)`,f.onclick=()=>{n.vis=!n.vis,f.innerHTML=J(n.vis?`eye`:`eyeoff`,{size:12}),f.classList.toggle(`on`,!n.vis),bd.emit(`treechange`)};let p=Y(`button`,`iconbtn ghost`,J(`pin`,{size:12}));p.title=`Pin in place`;let m=Y(`button`,`iconbtn ghost`,J(`focus`,{size:12}));m.title=`Frame in viewport  (F)`;let h=Y(`button`,`iconbtn ghost`,J(`close`,{size:12}));h.title=`Close  (Esc)`,u.append(f,m,p,h);let g=Y(`div`,`pop-body`),_=Od(n,{compact:!0,onDirty:()=>{u.querySelector(`.t`).textContent=n.name,t.refreshChrome()}});g.appendChild(_);let v=Y(`div`,`pop-foot`),y=Y(`button`,`btn sm ghost`,`${J(`panelR`,{size:12})} Inspector`);y.onclick=()=>{t.select(n.id),t.showInspector()};let b=Y(`button`,`btn sm ghost`,`${J(`solo`,{size:12})} Isolate`),x=()=>{b.classList.toggle(`on`,iu(n)),b.lastChild.textContent=iu(n)?` Leave`:` Isolate`};b.onclick=()=>{t.toggleIsolateNode(n),x()},x(),v.append(y,b),o.append(u,g,v),e.appendChild(o);let S={node:n,elm:o,tether:s,sheet:_,pinned:!1,detached:!1,pos:{x:0,y:0}};return r.set(n.id,S),h.onclick=()=>i(n.id),m.onclick=()=>t.focus(n),p.onclick=()=>{S.pinned=!S.pinned,S.detached=S.detached||S.pinned,p.classList.toggle(`on`,S.pinned),s.style.display=S.pinned?`none`:``},u.addEventListener(`pointerdown`,e=>{if(e.target.closest(`button`))return;u.classList.add(`grabbing`),u.setPointerCapture(e.pointerId);let t={x:e.clientX,y:e.clientY,px:S.pos.x,py:S.pos.y};S.detached=!0;let n=e=>{S.pos.x=t.px+(e.clientX-t.x),S.pos.y=t.py+(e.clientY-t.y),l(S)},r=()=>{u.classList.remove(`grabbing`),u.removeEventListener(`pointermove`,n),u.removeEventListener(`pointerup`,r)};u.addEventListener(`pointermove`,n),u.addEventListener(`pointerup`,r)}),o.addEventListener(`pointerdown`,()=>{[...r.values()].forEach(e=>e.elm.style.zIndex=`1`),o.style.zIndex=`2`}),S}let c=e=>{e.elm.style.animation=`none`,e.elm.offsetWidth,e.elm.style.animation=`popIn .22s var(--ease)`};function l(e){let t=n(),r=e.elm.offsetWidth||318,i=e.elm.offsetHeight||320,a=Math.min(Math.max(e.pos.x,t.left+10),Math.max(t.right-r-10,t.left+10)),o=Math.min(Math.max(e.pos.y,t.top+10),Math.max(t.bottom-i-10,t.top+10));return e.elm.style.left=a+`px`,e.elm.style.top=o+`px`,{x:a,y:o,w:r,h:i}}function u(e){r.forEach(t=>{let r=e.screenPos(t.node.id);if(!t.detached){let e=n(),i=t.elm.offsetWidth||318;if(r){let n=r.x+46;t.pos.x=n+i+12>e.right?r.x-i-16:n,t.pos.y=r.y-14}else t.pinned||(t.pos.x=e.right-i-20,t.pos.y=e.top+70)}let i=l(t);if(r&&!t.pinned){let e=r.x+r.w/2,n=r.y+r.h/2,a=(i.x>e?i.x:i.x+i.w)-e,o=i.y+22-n,s=Math.hypot(a,o);t.tether.style.display=s>8&&s<900?`block`:`none`,t.tether.style.left=e+`px`,t.tether.style.top=n+`px`,t.tether.style.width=s+`px`,t.tether.style.transform=`rotate(${Math.atan2(o,a)}rad)`}else t.tether.style.display=`none`})}return{openFor:s,toggle:o,close:i,closeAll:a,update:u,has:e=>r.has(e),count:()=>r.size}}var X={selection:new Set,cursorId:null,mode:`split`,cats:new Set(su),labelMode:`hover`,view:`persp`,tod:7.4,dayCycle:!1,transport:`edit`,paused:!1,realtime:!0,playCamId:null,snapshot:null},Z=e=>document.querySelector(e),Ad=Z(`#stage`),jd=Z(`#vpView`),Q=ad(Z(`#gl`),{onPick:(e,t)=>{if(e==null){!t.shiftKey&&!t.ctrlKey&&!t.metaKey&&$.select(null);return}$.select(e,{additive:t.ctrlKey||t.metaKey})}});Q.setHudElements(Z(`#vign`),Z(`#grain`));var Md=vd(Z(`#billboards`),Q,{onSelect:(e,t)=>$.select(e.id,{additive:t.ctrlKey||t.metaKey}),onOpen:e=>Nd.openFor(e),onContext:(e,t)=>{$.select(e.id),$.contextMenu(e,t)}}),Nd=kd(Z(`#popups`),{select:(...e)=>$.select(...e),focus:e=>$.focus(e),soloNode:e=>$.soloNode(e),toggleIsolateNode:e=>$.toggleIsolateNode(e),showInspector:()=>$.showInspector(),refreshChrome:()=>$.refreshChrome()},()=>{let e=jd.getBoundingClientRect();return{left:e.left,top:e.top,right:e.right,bottom:e.bottom}});function Pd(e,{silent:t=!1}={}){X.tod=(e+24)%24;let n=Jl.find(e=>e.type===`sun`),r=Jl.find(e=>e.type===`moon`),i=(X.tod-6)/12*Math.PI;n.props.elevation=62*Math.sin(i),n.props.azimuth=(90+(X.tod-6)*15+360)%360;let a=(X.tod-18)/12*Math.PI;r.props.elevation=58*Math.sin(a),r.props.azimuth=(90+(X.tod-18)*15+360)%360,r.props.phase=(r.props.phase+0)%1,Q.applyNode(n),bd.emit(`propchange`,{node:n,key:`elevation`,src:`tod`}),bd.emit(`propchange`,{node:r,key:`elevation`,src:`tod`});let o=Math.floor(X.tod),s=Math.floor(X.tod%1*60);Z(`#todClock`).textContent=`${String(o).padStart(2,`0`)}:${String(s).padStart(2,`0`)}`,t||Of._set(X.tod)}var $={selection:X.selection,get cursorId(){return X.cursorId},select(e,{additive:t=!1,range:n=!1,silent:r=!1}={}){if(e==null)X.selection.clear(),X.cursorId=null;else if(t)X.selection.has(e)?X.selection.delete(e):X.selection.add(e),X.cursorId=e;else if(n&&X.cursorId!=null){let t=Jl.map(e=>e.id),n=t.indexOf(X.cursorId),r=t.indexOf(e);t.slice(Math.min(n,r),Math.max(n,r)+1).forEach(e=>X.selection.add(e)),X.cursorId=e}else X.selection.clear(),X.selection.add(e),X.cursorId=e;Bd(),!r&&e!=null&&Ld.render()},focus(e){e&&(Q.focusOn(e),$.toast(`Framing <b>${e.name}</b>`))},isolate(e){let t=new Set([...e].filter(e=>Xl(e))),n=nu();tu(t.size===n.size&&[...t].every(e=>n.has(e))?[]:t),$.applyIsolation();let r=nu().size;$.toast(r?`Isolated <b>${r}</b> ${r===1?`entity`:`entities`}`:`Isolation cleared`)},toggleIsolateSelection(){if(!X.selection.size){ru()&&$.isolate([]);return}$.isolate([...X.selection])},toggleIsolateNode(e){let t=new Set(nu());t.has(e.id)?t.delete(e.id):t.add(e.id),tu(t),$.applyIsolation()},exitIsolation(){tu([]),$.applyIsolation(),$.toast(`Isolation cleared`)},applyIsolation(){Jl.forEach(e=>e.solo=iu(e)),Q.applyAll(),Ld.render(),lp(),Tf()},soloNode(e){$.isolate([e.id])},contextMenu(e,t){Pf(e,t)},toast:Ff,refreshChrome(){zd(),Ld.render(),Md.rebuild(Hd()),lp()},showInspector(){Mf(X.mode===`outliner`?`split`:X.mode)},addEntity(e,t){let n=Ul[e],r=(t&&Zl(t)?t:null)??ql.find(e=>e.name===Fd(n.cat))??ql[2],i=Gl(Id(n.label),e,[]);if(i.props.pos){let e=Q.camera.position.clone().add(Q.controls.target.clone().sub(Q.camera.position).setLength(Math.min(Q.camera.position.distanceTo(Q.controls.target),9)));i.props.pos=[+e.x.toFixed(2),Math.max(+e.y.toFixed(2),.6),+e.z.toFixed(2)]}r.kids.push(i),r.open=!0,Yl(),Q.applyNode(i),$.select(i.id),Ld.revealNode(i),Md.rebuild(Hd()),$.toast(`Added <b>${i.name}</b>`)},duplicate(e){if(!e||Zl(e))return;let t=Gl(Id(e.name.replace(/ \d+$/,``)),e.type,[],{props:JSON.parse(JSON.stringify(e.props)),dynamic:e.dynamic,notes:e.notes});t.props.pos&&(t.props.pos=t.props.pos.map((e,t)=>t===0?e+1.6:e));let n=e.parent?e.parent.kids:ql;n.splice(n.indexOf(e)+1,0,t),Yl(),Q.applyNode(t),$.select(t.id),Md.rebuild(Hd()),$.toast(`Duplicated <b>${e.name}</b>`)},remove(e){if(!e)return;if([`sky`,`sun`,`water`,`post`].includes(e.type)){$.toast(`That entity is required by the world`);return}let t=e=>{e.kids.slice().forEach(t),Q.remove(e)};t(e);let n=e.parent?e.parent.kids:ql;n.splice(n.indexOf(e),1),Yl(),X.selection.delete(e.id),Nd.has(e.id)&&Nd.close(e.id),Md.rebuild(Hd()),Ld.render(),zd(),$.toast(`Deleted <b>${e.name}</b>`)}};function Fd(e){return{Environment:`Environment`,Water:`Water`,Geometry:`Objects`,Lighting:`Lighting`,Cameras:`Cameras`,Effects:`Effects`}[e]||`Objects`}function Id(e){let t=new Set(Jl.map(e=>e.name));if(!t.has(e))return e;let n=2;for(;t.has(`${e} ${n}`);)n++;return`${e} ${n}`}var Ld=xd(Z(`#outliner`),$),Rd=null;function zd(){let e=Z(`#insBody`),t=Xl(X.cursorId);Rd?._dispose&&Rd._dispose(),e.innerHTML=``;let n=t?Ql(t):null;if(Z(`#insIcon`).innerHTML=J(n?n.icon:`settings`,{size:15,color:n?n.color:void 0}),Z(`#insTitle`).textContent=t?t.name:`Inspector`,Z(`#insSub`).textContent=t?X.selection.size>1?`${X.selection.size} selected · editing ${n.label}`:`${n.label} · #${String(t.id).padStart(3,`0`)}`:`Nothing selected`,Z(`#insFoot`).textContent=t?`${n.cat} · ${t.dynamic?`dynamic`:`static`}${t.locked?` · locked`:``}`:`—`,!t){e.innerHTML=`<div class="empty"><div><div class="big">No entity selected</div>
      Pick a billboard in the viewport, or a row in the outliner.<br>Press <span class="kbd">⌘K</span> to search the world.</div></div>`,Rd=null;return}Rd=Od(t,{onDirty:()=>{Ld.render(),zd()}}),e.appendChild(Rd),_d(e)}function Bd(){Q.setSelection([...X.selection]),Md.setSelection([...X.selection]),zd();let e=Xl(X.cursorId);Z(`#stSel`).textContent=X.selection.size?`${X.selection.size} selected · ${e?e.name:``}`:`nothing selected`,lp()}var Vd=e=>String(e).replace(/[&<>]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`})[e]),Hd=()=>Jl.filter(e=>!Zl(e)&&!Ql(e).noBillboard);Md.setCategories(X.cats),Md.rebuild(Hd());var Ud=Z(`#vpMenus`),Wd=J(`check`,{size:12,width:3});function Gd(e,t){let n=Y(`div`,`vm`),r=Y(`button`,`vmbtn`,``),i=Y(`div`,`vmpop`);n.append(r,i),Ud.appendChild(n);let a={wrap:n,btn:r,pop:i,setLabel(e){r.innerHTML=`${e}<span class="caret">${J(`chevdown`,{size:12})}</span>`},close(){n.classList.remove(`open`)},paint(){i.innerHTML=``,t(a,i)}};return a.row=(e,t,n,{keep:r=!1}={})=>{let o=Y(`div`,`vmrow${t?` on`:``}`,`<span class="tick">${Wd}</span>${e}`);return o.onclick=e=>{e.stopPropagation(),n(),a.paint(),r||a.close()},i.appendChild(o),o},a.head=e=>i.appendChild(Y(`div`,`vmhead`,e)),a.sep=()=>i.appendChild(Y(`div`,`vmsep`)),r.onclick=e=>{e.stopPropagation();let t=n.classList.contains(`open`);document.querySelectorAll(`.vm.open`).forEach(e=>e.classList.remove(`open`)),t||(a.paint(),n.classList.add(`open`))},a.paint(),a.setLabel(e),a}addEventListener(`pointerdown`,e=>{e.target.closest(`.vm`)||document.querySelectorAll(`.vm.open`).forEach(e=>e.classList.remove(`open`))});function Kd(e){let t=Object.values(Ul).find(t=>t.cat===e);return t?t.color:`#888`}var qd=e=>Jl.filter(t=>!Zl(t)&&Ql(t).cat===e).length,Jd=Gd(``,(e,t)=>{e.head(`Show in viewport`),su.forEach(t=>e.row(`<span class="swat" style="background:${Kd(t)}"></span>${t}<span class="n">${qd(t)}</span>`,X.cats.has(t),()=>{X.cats.has(t)?X.cats.delete(t):X.cats.add(t),Md.setCategories(X.cats),Yd()},{keep:!0})),e.sep(),e.row(`All categories`,X.cats.size===su.length,()=>{X.cats=new Set(su),Md.setCategories(X.cats),Yd()},{keep:!0}),e.row(`None`,X.cats.size===0,()=>{X.cats=new Set,Md.setCategories(X.cats),Yd()},{keep:!0})});function Yd(){let e=X.cats.size,t=su.length;Jd.setLabel(`${J(`layers`,{size:13})}Show <span class="val">${e===t?`All`:e===0?`None`:`${e}/${t}`}</span>`)}Yd();var Xd=[[`hover`,`Names on hover`],[`always`,`Names always`],[`none`,`Icons only`]],Zd=Gd(``,e=>{e.head(`Markers`),Xd.forEach(([t,n])=>e.row(n,X.labelMode===t,()=>qf(t)))});function Qd(){let e=Xd.find(([e])=>e===X.labelMode);Zd.setLabel(`${J(`tag`,{size:13})}Markers <span class="val">${e?e[1].replace(`Names `,``).replace(`Icons only`,`Icons`):``}</span>`)}Qd();var $d=[[`front`,`Front`,`Z`],[`back`,`Back`,``],[`right`,`Right`,`X`],[`left`,`Left`,``],[`top`,`Top`,`Y`],[`bottom`,`Bottom`,``]],ef=Gd(``,e=>{e.head(`Standard views`),$d.forEach(([t,n])=>e.row(n,X.view===t,()=>$f(t))),e.sep(),e.row(`Frame everything<span class="sc">⇧F</span>`,!1,()=>{Q.frameAll(),X.view=`persp`,tf()}),e.row(`Frame selection<span class="sc">F</span>`,!1,()=>$.focus(Xl(X.cursorId)))});function tf(){let e=$d.find(([e])=>e===X.view);ef.setLabel(`${J(`camera`,{size:13})}View <span class="val">${e?e[1]:`Perspective`}</span>`)}tf();var nf=Z(`#transport`),rf=(e,t,n)=>{let r=Y(`button`,`tbtn ${e}`,J(t,{size:13}));return r.title=n,nf.appendChild(r),r},af=rf(`play`,`play`,`Play — run the world through a scene camera  (Alt P)`),of=rf(`sim`,`sim`,`Simulate — run the world, keep the editor camera  (Alt S)`),sf=rf(`pause`,`pause`,`Pause / resume  (P)`),cf=rf(`step`,`step`,`Advance one frame  (.)`),lf=rf(`stop`,`stop`,`Stop — restore the editor state  (Esc)`);nf.appendChild(Y(`div`,`sep`));var uf=Y(`button`,`tbtn rt on`,`<span class="led"></span>Realtime`);uf.title=`Realtime viewport — animate and redraw continuously  (Ctrl R)`,nf.appendChild(uf);var df=Y(`div`,`statechip edit`,`Edit`);nf.appendChild(df);var ff=Z(`#gateMask`),pf=Y(`div`,`bar l`),mf=Y(`div`,`bar r`);ff.append(pf,mf);var hf={"16:9":16/9,"2.39:1":2.39,"4:3":4/3,"1:1":1};function gf(e){if(!e){ff.classList.remove(`on`);return}let t=jd.getBoundingClientRect(),n=hf[e.props.gate]||16/9,r=t.width/t.height,i=r>n?0:(t.height-t.width/n)/2,a=r>n?(t.width-t.height*n)/2:0;ff.classList.add(`on`),ff.querySelector(`.bar.t`).style.height=i+`px`,ff.querySelector(`.bar.b`).style.height=i+`px`,pf.style.width=a+`px`,mf.style.width=a+`px`;let o=Z(`#gateTag`);o.textContent=`${e.name} · ${e.props.gate} · ${Math.round(e.props.fov)}° · f/${e.props.aperture}`,o.style.top=i+10+`px`,o.style.left=a+14+`px`}var _f=()=>{let e=Xl(X.cursorId);return e&&e.type===`camera`?e:Jl.find(e=>e.type===`camera`)||null};function vf(){X.snapshot={tod:X.tod,iso:[...nu()],ids:Jl.map(e=>e.id),nodes:Jl.map(e=>({id:e.id,name:e.name,vis:e.vis,locked:e.locked,dynamic:e.dynamic,props:JSON.parse(JSON.stringify(e.props))}))}}function yf(){let e=X.snapshot;if(!e)return;let t=new Set(e.ids);Jl.filter(e=>!t.has(e.id)).forEach(e=>{Q.remove(e);let t=e.parent?e.parent.kids:ql,n=t.indexOf(e);n>=0&&t.splice(n,1),X.selection.delete(e.id),Nd.has(e.id)&&Nd.close(e.id)}),Yl(),e.nodes.forEach(e=>{let t=Xl(e.id);t&&(t.name=e.name,t.vis=e.vis,t.locked=e.locked,t.dynamic=e.dynamic,t.props=e.props)}),tu(e.iso),Jl.forEach(e=>e.solo=iu(e)),X.snapshot=null,Pd(e.tod),Q.applyAll(),Ld.render(),zd(),Tf(),Md.rebuild(Hd())}function bf(e){if(e===`edit`){let e=X.transport;e!==`edit`&&yf(),X.transport=`edit`,X.paused=!1,X.playCamId=null,Q.setViewCamera(null),document.body.classList.remove(`playing`),gf(null),e!==`edit`&&Ff(`Stopped · editor state restored`)}else{if(X.transport===`edit`&&vf(),X.realtime=!0,X.paused=!1,e===`play`){let t=_f();t&&Q.setViewCamera(t)?(X.transport=`play`,X.playCamId=t.id,document.body.classList.add(`playing`),gf(t),Ff(`Playing through <b>${t.name}</b>`)):(Ff(`No camera to play through — simulating instead`),e=`simulate`)}e===`simulate`&&(X.transport=`simulate`,X.playCamId=null,Q.setViewCamera(null),document.body.classList.remove(`playing`),gf(null),Ff(`Simulating`))}wf()}function xf(e){X.paused=e,wf(),Ff(e?`Paused`:`Resumed`)}function Sf(){X.paused||xf(!0);let e=1/30;Q.stepOnce(e),Df(!0)&&Pd(X.tod+e*Ef().props.rate/600)}function Cf(e){X.realtime=e,wf()}function wf(){let e=X.transport!==`edit`;af.classList.toggle(`on`,X.transport===`play`),of.classList.toggle(`on`,X.transport===`simulate`),sf.classList.toggle(`on`,X.paused),sf.innerHTML=J(X.paused?`play`:`pause`,{size:13}),cf.disabled=!X.paused,lf.disabled=!e,uf.classList.toggle(`on`,X.realtime),uf.disabled=e,df.textContent=X.paused?`Paused`:X.transport===`play`?`Play`:X.transport===`simulate`?`Simulate`:X.realtime?`Edit`:`Edit · static`,df.className=`statechip `+(X.paused?`paused`:X.transport);let t=X.realtime&&!X.paused;Q.setClock({animate:t,render:t}),Z(`#stHint`).textContent=e?X.paused?`Paused — press . to step a frame, Esc to stop`:`Running — Esc stops and restores the editor state`:`Click a billboard to select · click it again for settings · drag rows to re-parent`}af.onclick=()=>bf(X.transport===`play`?`edit`:`play`),of.onclick=()=>bf(X.transport===`simulate`?`edit`:`simulate`),sf.onclick=()=>xf(!X.paused),cf.onclick=()=>Sf(),lf.onclick=()=>bf(`edit`),uf.onclick=()=>Cf(!X.realtime);function Tf(){let e=Z(`#isoBanner`),t=nu().size;if(!t){e.style.display=`none`,e.innerHTML=``;return}e.style.display=`flex`,e.title=`${t} ${t===1?`entity is`:`entities are`} isolated — everything else is hidden`,e.innerHTML=`${J(`solo`,{size:11,color:`currentColor`})}<span>${t}</span>`;let n=Y(`button`,`chipbtn`,`Exit`);n.onclick=()=>$.exitIsolation(),e.appendChild(n)}var Ef=()=>Jl.find(e=>e.type===`sun`),Df=(e=!1)=>(e||X.realtime&&!X.paused)&&(X.transport!==`edit`||Ef().props.animate),Of=ud({min:0,max:24,value:X.tod,dec:2,unit:`h`,thin:!0,onInput:e=>Pd(e,{silent:!0})});Of.querySelector(`.vpill`).style.display=`none`,Z(`#todSlider`).appendChild(Of);var kf=Z(`#todPlay`);kf.innerHTML=J(`play`,{size:12}),kf.onclick=()=>{X.dayCycle=!X.dayCycle;let e=Ef();e.props.animate=X.dayCycle,kf.innerHTML=J(X.dayCycle?`pause`:`play`,{size:12}),kf.classList.toggle(`on`,X.dayCycle),bd.emit(`propchange`,{node:e,key:`animate`,src:`tod`}),X.dayCycle&&!X.realtime&&Cf(!0)},Z(`#brandMark`).innerHTML=J(`world`,{size:15}),Z(`#btnFrame`).innerHTML=J(`focus`,{size:13}),Z(`#btnClosePops`).innerHTML=J(`close`,{size:13}),Z(`#btnHelp`).innerHTML=J(`command`,{size:13}),Z(`#insPopout`).innerHTML=J(`copy`,{size:13}),Z(`#insFocus`).innerHTML=J(`focus`,{size:13}),Z(`#btnFrame`).onclick=()=>{Q.frameAll(),Ff(`Framed the world`)},Z(`#btnClosePops`).onclick=()=>{Nd.closeAll(),Ff(`Popups closed`)},Z(`#btnHelp`).onclick=()=>Hf(`?`),Z(`#btnPalette`).onclick=()=>Hf(``),Z(`#insFocus`).onclick=()=>$.focus(Xl(X.cursorId)),Z(`#insPopout`).onclick=()=>{let e=Xl(X.cursorId);e&&!Ql(e).noBillboard?Nd.openFor(e):e&&Ff(`That entity has no billboard`)};var Af=[`cube`,`sphere`,`torus`,`cylinder`,`plane`,`pointlight`,`spotlight`,`camera`,`particles`,`probe`,`audio`],jf=hd([`Add entity…`,...Af.map(e=>Ul[e].label)],`Add entity…`,e=>{let t=Af.find(t=>Ul[t].label===e);jf._set(`Add entity…`),t&&$.addEntity(t,Xl(X.cursorId))},{width:148});Z(`#addHost`).appendChild(jf);function Mf(e){X.mode=e,Z(`#outliner`).classList.toggle(`collapsed`,e===`inspector`),Z(`#inspector`).classList.toggle(`collapsed`,e===`outliner`),document.querySelectorAll(`#layoutSeg button`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e)),setTimeout(()=>{Q.resize(),_d()},340)}document.querySelectorAll(`#layoutSeg button`).forEach(e=>e.onclick=()=>Mf(e.dataset.mode));var Nf=Z(`#ctxmenu`);function Pf(e,t){let n=[[`Open settings popup`,`settings`,()=>Nd.openFor(e),!Ql(e).noBillboard&&!Zl(e)],[`Frame in viewport`,`focus`,()=>$.focus(e),!0,`F`],[`Rename`,`copy`,()=>{Ld.render();let t=document.querySelector(`.row[data-id="${e.id}"] .nm`);t&&t.dispatchEvent(new MouseEvent(`dblclick`,{bubbles:!0}))},!0,`F2`],[`sep`],[e.vis?`Hide`:`Show`,e.vis?`eyeoff`:`eye`,()=>{e.vis=!e.vis,bd.emit(`treechange`)},!0,`H`],[e.locked?`Unlock`:`Lock`,e.locked?`unlock`:`lock`,()=>{e.locked=!e.locked,bd.emit(`treechange`)},!0,`L`],[iu(e)?`Leave isolation`:`Isolate`,`solo`,()=>$.toggleIsolateNode(e),!0,`I`],[`Duplicate`,`copy`,()=>$.duplicate(e),!Zl(e),`⌘D`],[`sep`],[`Delete`,`trash`,()=>$.remove(e),!0,`⌫`,!0]];Nf.innerHTML=``,n.forEach(e=>{if(e[0]===`sep`){Nf.appendChild(Y(`div`,`sep`));return}let[t,n,r,i=!0,a=``,o=!1]=e;if(!i)return;let s=Y(`div`,`mi${o?` danger`:``}`,`${J(n,{size:13})}<span>${t}</span>${a?`<span class="sc">${a}</span>`:``}`);s.onclick=()=>{Nf.classList.remove(`open`),r()},Nf.appendChild(s)}),Nf.classList.add(`open`);let r=Nf.offsetWidth,i=Nf.offsetHeight;Nf.style.left=Math.min(t.clientX,innerWidth-r-10)+`px`,Nf.style.top=Math.min(t.clientY,innerHeight-i-10)+`px`}addEventListener(`pointerdown`,e=>{e.target.closest(`#ctxmenu`)||Nf.classList.remove(`open`)}),Ad.addEventListener(`contextmenu`,e=>e.preventDefault());function Ff(e){let t=Y(`div`,`toast`,e);Z(`#toasts`).appendChild(t),setTimeout(()=>{t.style.transition=`opacity .3s, transform .3s`,t.style.opacity=`0`,t.style.transform=`translateY(6px)`},1500),setTimeout(()=>t.remove(),1900)}var If=Z(`#palette`),Lf=Z(`#palInput`),Rf=Z(`#palList`),zf=[],Bf=0;function Vf(){let e=Xl(X.cursorId);return[{label:`Play — run through a camera`,sub:`transport`,run:()=>bf(`play`)},{label:`Simulate — run the world`,sub:`transport`,run:()=>bf(`simulate`)},{label:`Pause / resume`,sub:`transport`,run:()=>xf(!X.paused)},{label:`Step one frame`,sub:`transport`,run:()=>Sf()},{label:`Stop and restore`,sub:`transport`,run:()=>bf(`edit`)},{label:`Realtime viewport: turn ${X.realtime?`off`:`on`}`,sub:`viewport`,run:()=>Cf(!X.realtime)},{label:`Isolate selection`,sub:`view`,run:()=>$.toggleIsolateSelection()},{label:`Exit isolation`,sub:`view`,run:()=>$.exitIsolation()},{label:`View — front`,sub:`camera`,run:()=>$f(`front`)},{label:`View — back`,sub:`camera`,run:()=>$f(`back`)},{label:`View — left`,sub:`camera`,run:()=>$f(`left`)},{label:`View — right`,sub:`camera`,run:()=>$f(`right`)},{label:`View — top`,sub:`camera`,run:()=>$f(`top`)},{label:`View — bottom`,sub:`camera`,run:()=>$f(`bottom`)},{label:`Frame everything`,sub:`view`,run:()=>Q.frameAll()},{label:`Frame selection`,sub:`view`,run:()=>$.focus(e)},{label:`Close all popups`,sub:`view`,run:()=>Nd.closeAll()},{label:`Labels: always on`,sub:`billboards`,run:()=>qf(`always`)},{label:`Labels: on hover`,sub:`billboards`,run:()=>qf(`hover`)},{label:`Labels: icons only`,sub:`billboards`,run:()=>qf(`none`)},{label:`Time — sunrise 06:00`,sub:`time`,run:()=>Pd(6)},{label:`Time — golden hour 17:40`,sub:`time`,run:()=>Pd(17.66)},{label:`Time — blue hour 19:10`,sub:`time`,run:()=>Pd(19.16)},{label:`Time — midnight 00:00`,sub:`time`,run:()=>Pd(0)},{label:`Toggle day cycle`,sub:`time`,run:()=>kf.click()},{label:`Layout — outliner only`,sub:`layout`,run:()=>Mf(`outliner`)},{label:`Layout — split`,sub:`layout`,run:()=>Mf(`split`)},{label:`Layout — inspector only`,sub:`layout`,run:()=>Mf(`inspector`)},...Af.map(t=>({label:`Add ${Ul[t].label}`,sub:`create`,run:()=>$.addEntity(t,e)}))]}function Hf(e=``){If.classList.add(`open`),Lf.value=e===`?`?``:e,Wf(),Lf.focus()}var Uf=()=>If.classList.remove(`open`);function Wf(){let e=Lf.value.trim().toLowerCase(),t=Jl.filter(t=>!e||t.name.toLowerCase().includes(e)||Ql(t).label.toLowerCase().includes(e)).slice(0,40).map(e=>({label:e.name,sub:Ql(e).label,icon:Ql(e).icon,color:Ql(e).color,run:()=>{$.select(e.id),Ld.revealNode(e),$.focus(e)}})),n=Vf().filter(t=>!e||t.label.toLowerCase().includes(e));zf=[...t,...n],Bf=0,Rf.innerHTML=zf.map((e,t)=>`<div class="palrow${t===0?` on`:``}" data-i="${t}">
       ${J(e.icon||`command`,{size:14,color:e.color})}<span>${Vd(e.label)}</span><span class="sub">${e.sub}</span></div>`).join(``)||`<div class="nohits">No matches</div>`,Rf.querySelectorAll(`.palrow`).forEach(e=>{e.onclick=()=>{zf[+e.dataset.i].run(),Uf()},e.onmouseenter=()=>{Bf=+e.dataset.i,Gf()}})}var Gf=()=>Rf.querySelectorAll(`.palrow`).forEach((e,t)=>e.classList.toggle(`on`,t===Bf));Lf.addEventListener(`input`,Wf),Lf.addEventListener(`keydown`,e=>{e.stopPropagation(),e.key===`Escape`&&Uf(),e.key===`ArrowDown`&&(Bf=Math.min(Bf+1,zf.length-1),Gf(),Kf(),e.preventDefault()),e.key===`ArrowUp`&&(Bf=Math.max(Bf-1,0),Gf(),Kf(),e.preventDefault()),e.key===`Enter`&&(zf[Bf]?.run(),Uf())});var Kf=()=>Rf.querySelectorAll(`.palrow`)[Bf]?.scrollIntoView({block:`nearest`});If.addEventListener(`pointerdown`,e=>{e.target.closest(`.palbox`)||Uf()});function qf(e){X.labelMode=e,Md.setLabelMode(e),Qd()}addEventListener(`keydown`,e=>{if(e.target.matches(`input, textarea`))return;let t=Xl(X.cursorId),n=e.key.toLowerCase();if((e.metaKey||e.ctrlKey)&&n===`k`){e.preventDefault(),Hf();return}if((e.metaKey||e.ctrlKey)&&n===`d`){e.preventDefault(),$.duplicate(t);return}if((e.metaKey||e.ctrlKey)&&n===`r`){e.preventDefault(),Cf(!X.realtime);return}if(e.altKey&&n===`p`){e.preventDefault(),bf(X.transport===`play`?`edit`:`play`);return}if(e.altKey&&n===`s`){e.preventDefault(),bf(X.transport===`simulate`?`edit`:`simulate`);return}if(n===`p`&&!e.altKey&&!e.metaKey&&!e.ctrlKey){xf(!X.paused);return}if(e.key===`.`){Sf();return}if(e.key===`Escape`){if(Uf(),Nf.classList.remove(`open`),X.transport!==`edit`){bf(`edit`);return}if(ru()){$.exitIsolation();return}Nd.count()?Nd.closeAll():$.select(null);return}if(n===`f`){e.shiftKey?Q.frameAll():$.focus(t);return}if(n===`h`&&t){t.vis=!t.vis,bd.emit(`treechange`);return}if(n===`l`&&t){t.locked=!t.locked,bd.emit(`treechange`);return}if(n===`i`){$.toggleIsolateSelection();return}if(n===`enter`&&t&&!Ql(t).noBillboard&&!Zl(t)){Nd.toggle(t);return}if((e.key===`Delete`||e.key===`Backspace`)&&t){e.preventDefault(),$.remove(t);return}if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=Jl.filter(e=>Jf(e)).map(e=>e.id),n=t.indexOf(X.cursorId),r=t[Math.min(Math.max(n+(e.key===`ArrowDown`?1:-1),0),t.length-1)];r!=null&&($.select(r,{additive:!1}),Ld.revealNode(Xl(r)))}e.key===`ArrowRight`&&t&&t.kids.length&&(t.open=!0,Ld.render()),e.key===`ArrowLeft`&&t&&(t.kids.length&&t.open?t.open=!1:t.parent&&$.select(t.parent.id),Ld.render())});var Jf=e=>{let t=e.parent;for(;t;){if(!t.open)return!1;t=t.parent}return!0};bd.on(`propchange`,({node:e,src:t})=>{Q.applyNode(e),t!==`tod`&&(e.type===`sun`||e.type===`moon`)&&Yf()}),bd.on(`treechange`,()=>{Yl(),Q.applyAll(),Ld.render(),zd(),Md.rebuild(Hd()),Bd()});function Yf(){X.tod=(6+(Jl.find(e=>e.type===`sun`).props.azimuth-90)/15+24)%24;let e=Math.floor(X.tod),t=Math.floor(X.tod%1*60);Z(`#todClock`).textContent=`${String(e).padStart(2,`0`)}:${String(t).padStart(2,`0`)}`,Of._set(X.tod)}var Xf=Z(`#axisOrb`),Zf=Z(`#orbHint`),Qf={right:{v:[1,0,0],label:`X`,color:`var(--ax-x)`},left:{v:[-1,0,0],label:``,color:`var(--ax-x)`,neg:!0},top:{v:[0,1,0],label:`Y`,color:`var(--ax-y)`},bottom:{v:[0,-1,0],label:``,color:`var(--ax-y)`,neg:!0},front:{v:[0,0,1],label:`Z`,color:`var(--ax-z)`},back:{v:[0,0,-1],label:``,color:`var(--ax-z)`,neg:!0}};function $f(e){let t=Qf[e];if(t){if(X.transport===`play`){Ff(`Stop the run to move the editor camera`);return}Q.snapView(new H(...t.v)),X.view=e,tf(),Ff(`${e[0].toUpperCase()+e.slice(1)} view`)}}var ep=()=>{X.view!==`persp`&&(X.view=`persp`,tf())};function tp(e,t){if(X.view===`persp`||Q.isFlying)return;let n=Qf[X.view];n&&e.position.clone().sub(t.target).normalize().dot(new H(...n.v))<.9995&&ep()}var np=Object.entries(Qf).map(([e,t])=>{let n=Y(`div`,`stem`);n.style.background=t.color;let r=Y(`div`,`ax${t.neg?` neg`:``}`,t.label);return r.style.background=t.color,r.style.color=t.neg?t.color:`#000`,r.title=`${e[0].toUpperCase()+e.slice(1)} view`,r.addEventListener(`pointerdown`,e=>e.stopPropagation()),r.addEventListener(`click`,t=>{t.stopPropagation(),$f(e)}),r.addEventListener(`pointerenter`,()=>{Zf.textContent=e}),r.addEventListener(`pointerleave`,()=>{Zf.textContent=`drag to orbit`}),Xf.append(n,r),{stem:n,dot:r,a:t}});Zf.textContent=`drag to orbit`,Xf.addEventListener(`pointerdown`,e=>{if(e.target.closest(`.ax`)||X.transport===`play`)return;Xf.setPointerCapture(e.pointerId);let t={x:e.clientX,y:e.clientY},n=e=>{Q.orbitBy(e.clientX-t.x,e.clientY-t.y),t={x:e.clientX,y:e.clientY}},r=()=>{Xf.removeEventListener(`pointermove`,n),Xf.removeEventListener(`pointerup`,r)};Xf.addEventListener(`pointermove`,n),Xf.addEventListener(`pointerup`,r)}),Xf.addEventListener(`dblclick`,()=>{Q.frameAll(),Ff(`Framed the world`)});var rp=Z(`#vpStats`),ip=[[`perf`,`fps`],[`geo`,`tris`],[`ents`,`entities`],[`day`,`daylight`],[`iso`,`isolated`]],ap={perf:`Frames per second and the time each frame took`,geo:`Triangles and draw calls in the last frame, across every pass`,ents:`Entities in the world, and how many are visible right now`,day:`How much daylight the sun is giving, and its elevation`,iso:`How many entities the isolation set is holding`},op={};ip.forEach(([e,t])=>{let n=Y(`div`,`stat`,`<span class="lb">${t}</span><span class="vl">—</span>`);n.title=ap[e]||``,rp.appendChild(n),op[e]={cell:n,vl:n.querySelector(`.vl`)}});var sp=(e,t,n=``,{show:r=!0,warn:i=!1,dim:a=!1}={})=>{let o=op[e];if(!o)return;o.cell.classList.toggle(`hide`,!r),o.cell.classList.toggle(`warn`,i),o.vl.classList.toggle(`dim`,a);let s=n?`${t}<span class="sub"> · ${n}</span>`:String(t);o.vl.innerHTML!==s&&(o.vl.innerHTML=s)},cp=e=>e.toLocaleString(`en-US`);function lp(){let e=Jl.filter(e=>!Zl(e)),t=e.filter(e=>ou(e));sp(`ents`,e.length,`${t.length} visible`);let n=nu().size;sp(`iso`,n,``,{show:n>0,warn:!0})}var up=0;Q.start(({fps:e,dt:t,camera:n,controls:r,dayFactor:i,playing:a})=>{t>0&&Df()&&Pd(X.tod+t*Ef().props.rate/600),Md.update(),Nd.update(Md);let o=Q.camera;if(np.forEach(({stem:e,dot:t,a:n})=>{let r=new H(...n.v).applyQuaternion(o.quaternion.clone().invert()),i=38+r.x*26,a=38-r.y*26;t.style.left=i+`px`,t.style.top=a+`px`,t.style.marginLeft=`-8px`,t.style.marginTop=`-8px`,t.style.opacity=String(.35+(r.z+1)*.32),t.style.zIndex=String(Math.round(100+r.z*50));let s=i-38,c=a-38;e.style.width=Math.hypot(s,c)+`px`,e.style.transform=`rotate(${Math.atan2(c,s)}rad)`,e.style.opacity=String(.15+(r.z+1)*.16)}),tp(Q.camera,r),performance.now()-up>250){up=performance.now();let t=Q.renderInfo;sp(`perf`,e.toFixed(0),`${(1e3/Math.max(e,1)).toFixed(1)} ms`,{warn:e<24}),sp(`geo`,cp(t.triangles),`${cp(t.calls)} draws`),sp(`day`,`${(i*100).toFixed(0)}%`,`${Ef().props.elevation.toFixed(0)}°`);let o=n.position;Z(`#stRender`).textContent=X.paused?`paused · on-demand redraw`:X.realtime?`WebGL2 · ACES · realtime`:`WebGL2 · ACES · on-demand redraw`,Z(`#stCam`).textContent=a?`through ${Xl(X.playCamId)?.name||`camera`} · ${X.tod.toFixed(2).padStart(5,`0`)} h`:`${o.x.toFixed(1)}, ${o.y.toFixed(1)}, ${o.z.toFixed(1)} · ${n.position.distanceTo(r.target).toFixed(1)} m · ${X.tod.toFixed(2).padStart(5,`0`)} h`}}),addEventListener(`resize`,()=>{X.transport===`play`&&gf(Xl(X.playCamId))}),Pd(7.4),Q.applyAll(),Ld.render(),Mf(`split`),$.select(Jl.find(e=>e.name===`Anchor Cube`).id),Md.setLabelMode(`hover`),Tf(),wf(),setTimeout(()=>Ff(`Click a billboard to select · click again for settings`),700),window.frontier={state:X,app:$,setTimeOfDay:Pd,vp:Q,popups:Nd,outliner:Ld,billboards:Md,world:{flat:Jl,scene:ql},setTransport:bf,setPaused:xf,setRealtime:Cf,stepFrame:Sf,snapView:$f};